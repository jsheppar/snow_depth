...
set(Qt5Sensors_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/qt/QtSensors/5.12.9"
        "${_qt5Sensors_install_prefix}/include/qt/QtSensors/5.12.9/QtSensors"
    )
    ...
    foreach(_module_dep ${_Qt5Sensors_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5Sensors_FIND_VERSION_EXACT}
    ...
    _populate_Sensors_target_properties(RELEASE "libQt5Sensors.5.12.9.dylib" "" )
