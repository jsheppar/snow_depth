...
set_target_properties(GEOS::geos PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgeos.3.10.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgeos.3.10.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS GEOS::geos )
list(APPEND _IMPORT_CHECK_FILES_FOR_GEOS::geos "${_IMPORT_PREFIX}/lib/libgeos.3.10.0.dylib" )
